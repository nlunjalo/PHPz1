...
<meta charset="UTF-8">
<head>
<meta name="description" content="Projektni zadatak VVG Web Aplikacije">
<meta name="keywords" content="Projekt, VVG, WEB">
...
<main>
		<h1 class="post-title">NOVOSTI</h1>
		<div id="news_gallery">
			<figure id="1">
				<img src="../media/sub/globe-network-100697951-large.jpg" alt="HTML 5 Connects the world" title="HTML 5 Connects the world">
				<figcaption>HTML 5 Connects the world<figcaption>
			</figure>
			<figure id="2">
				<img src="../media/sub/html5-rocket-100254091-primary.idge.jpg" alt="HTML 5 The new World!" title="HTML 5 The new World!">
				<figcaption>HTML 5 The new World!<figcaption>
			</figure>
		</div>
		<hr>
		...
		<div class="news">
			...
			<h2>HTML5: Where the core web technology is headed now</h2></a>
			<p class="description">
		...
		<h4>HTML5’s incremental improvements</h4>
		<p>
		...
		<p>Izvor: <a href="https://www.infoworld.com/article/3198460/web-development/html5-where-the-core-web-technology-is-headed-now.html" target="_blank">InfoWorld.com</a></p>
		<p><a href="novosti.php">Povratak na novosti</a></p>
		</div>
		</blockquote>
		</article>
